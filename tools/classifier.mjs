...
const rules = {
  ...
  alcohol: /слабоалкогольн|пиво|вино|віно|віскі|лікер|горіл|сидр|шампан|ігрист|брют|просек|prosecco|frizzante|аперитив|бренді|коньяк|ром|джин|текіл|вермут|бальзам.*\d+%/,
