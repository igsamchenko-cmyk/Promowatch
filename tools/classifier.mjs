...
const rules = {
  ...
  plantDrink: /напій.*(вівсян|мигдал|соєв|рисов|кокос)|vega milk|oat&|oat\s*banana/,
  nonAlcoholic: /безалкогольн/,
  alcohol: /пиво|вино|віно|віскі|лікер|горіл|сидр|шампан|ігрист|брют|просек|prosecco|frizzante|аперитив|бренді|коньяк|ром|джин|текіл|вермут|бальзам.*\d+%/,
  ...
  ready: /плов|крем-суп|(^|\s)суп(\s|$)|смажен[а-яіїєґ]* картоп|гриль|салат готов|готов[а-яіїєґ]* страв/,
  ...
  cottageDairy: /сир кисломол|кисломолочн[а-яіїєґ]* сир|творог|сирок|сирков|паста сирков|глазурован|actimel/,
  ...
  drinks: /сік|нектар|напій|вода|(^|[^а-яіїєґ])квас(?![а-яіїєґ])|cola|coca|pepsi|sprite|(^|[^a-z])fanta([^a-z]|$)|тонік|лимонад|енергет/,
  ...
  snacks: /насіння|арахіс|горіх|фісташ|ч[іи]пс|снек|сухар|крекер|грінк|маршмелоу|сушен[а-яіїєґ]* багет|jokers/,
...
export function inferSubcategory(name, category) {
  ...
  if (category === "Молочні") {
    ...
    if (/сирок|сирков|паста сирков|глазурован|десерт|пудинг|коктейль/.test(text)) return "Сирки та десерти";
